...
function delObject7(){sqlQuery('DELETE FROM `Object_DATA` WHERE datediff( NOW(), `last_updated` ) > 7 AND datediff( NOW(), `last_updated` ) < 14 ;','update');}
function delObject14(){sqlQuery('DELETE FROM `Object_DATA` WHERE datediff( NOW(), `last_updated` ) > 14 AND datediff( NOW(), `last_updated` ) < 28 ;','update');}
function delObject28(){sqlQuery('DELETE FROM `Object_DATA` WHERE datediff( NOW(), `last_updated` ) > 28 AND datediff( NOW(), `last_updated` ) < 365 ;','update');}
function delObject365(){sqlQuery('DELETE FROM `Object_DATA` WHERE datediff( NOW(), `last_updated` ) > 365 ;','update');}
